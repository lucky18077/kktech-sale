		...
		<div class="modal-content">
			<div class="modal-body p-5">
				<div class="row justify-content-between align-items-center mb-3">
					<div class="col-md-6">
						<div class="mb-4">
							<img src="/admin/images/logo.svg" width="130" class="img-fluid" alt="logo">
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-7">
						...
						<div>
							...
							<p class="mb-1">367 Hillcrest Lane, Irvine, California,
								United States</p>
							<p class="mb-1"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fc988e999d918f8c938fbc99849d918c9099d29f9391">[email�protected]</a></p>
						</div>
					</div>
					<div class="col-md-5">
						...
						<div>
							...
							<p class="mb-1">367 Hillcrest Lane, Irvine, California,
								United States</p>
							<p class="mb-1"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6a070309020b0f062a0f120b071a060f44090507">[email�protected]</a></p>
						</div>
					</div>
				</div>
				<div class="mb-4">
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-body text-center">
				<span class="avatar avatar-xl bg-danger-transparent rounded-circle text-danger mb-3">
				...
				<div class="d-flex justify-content-center">
					...
					<a href="subscription.html" class="btn btn-primary">Yes, Delete</a>
				</div>
			</div>
		</div>
	</div>
