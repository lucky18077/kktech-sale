...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <button class="btn btn-primary addProductCategory"><i class="ti ti-circle-plus me-1"></i>Add Product Category</button>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 p-2 editProductCategory" data-data='@json($item)'>
    ...
    <div class="modal fade" id="productCategory">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="page-title">
                        <h4 id="submitBtn">Add Product Category</h4>
                    </div>
    ...
    <script>
        $(".addProductCategory").on("click", function() {
            ...
            $("#submitBtn").text("Add Product Category");
            $("input[name='id']").val('');
            $("input[name='name']").val('');
        ...
        $(document).on("click", ".editProductCategory", function() {
            ...
            $("#submitBtn").text("Update Product Category");
