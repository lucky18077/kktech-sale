...
<div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4 class="fw-bold">Designations</h4>
                    <h6>Manage designations</h6>
                </div>
            </div>

            <div class="page-btn">
                <button class="btn btn-primary addDesignation"><i class="ti ti-circle-plus me-1"></i>Add Designation</button>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 p-2 editDesignation" data-data="{{ @json_encode($designation) }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="page-title">
                        <h4 id="submitBtn">Add Desingation</h4>
                    </div>
    ...
    <script>
        $(".addDesignation").on("click", function() {
            ...
            $("#submitBtn").text("Add Designation");
